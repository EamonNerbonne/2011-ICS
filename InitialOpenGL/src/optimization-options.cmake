...
elseif(MSVC)
	...
	set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /EHa /arch:SSE2 /W4 /MP") #SEH exceptions,SSE2 support, extra warnings
	set(CMAKE_CXX_FLAGS_RELEASE " /Ox /Ot /GL /Oy /Oi /GS- /fp:fast /fp:except- /MT -DNDEBUG")
